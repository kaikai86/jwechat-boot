...
public class WxCorpConfig implements InitializingBean {
    ...
    private String oaClockInAgentId;
    private String oaApproveAgentId;
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if (this.enabled) {
            ...
            log.info("-----------------------> 当前配置企业微信默认应用 打卡AgentId:{} <-----------------------",this.oaClockInAgentId);
            log.info("-----------------------> 当前配置企业微信默认应用 审批AgentId:{} <-----------------------",this.oaApproveAgentId);
